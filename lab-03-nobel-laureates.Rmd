...
***There are `r nrow(nobel)` rows and `r ncol(nobel)` columns in the the dataset. Each row represents a nobel winner.***
...
ggplot(data = nobel_living_science,aes(y = country_us)) +
  geom_bar() +
  facet_wrap(~category) +
  labs(title = "US vs. Other Science Nobel Prize Winners", y = "country")
```
